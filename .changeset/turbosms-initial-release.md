...
- `countSegments()` reports encoding and segment count, including the UCS-2 drop to 70 characters that Cyrillic forces
- Publishes `TurboSmsSentEvent` / `TurboSmsFailedEvent`, and `TurboSmsLowBalanceEvent` from the optional scheduled balance check
